            ...
            if(size>0)
            {
                ...
                for(Map.Entry<Integer, ArrayList<OrderPayment>> entry : orderPayments.entrySet())
                {
                    for(OrderPayment oi:entry.getValue())
                        ...
                        {
                            pw.print("<form method='get' action='SalesUpdate'>");
                            pw.print("<tr>");
                            ...
                            pw.print("<td><input type='hidden' name='userName' value='"+oi.getUserName()+"' class='btnbuy'></td>");
                            pw.print("<td><input type='hidden' name='address' value='"+oi.getUserAddress()+"' class='btnbuy'></td>");
                            pw.print("<td><input type='hidden' name='cardNo' value='"+oi.getCreditCardNo()+"' class='btnbuy'></td>");
                            pw.print("<td><input type='hidden' name='price' value='"+oi.getOrderPrice()+"' class='btnbuy'></td>");
