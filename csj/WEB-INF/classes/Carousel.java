			...
			if(user.equals(utility.username()))
			{
				...
				*/
				...
				for(String prod : productsList){
					...
					sb.append("<li id='item'><img src='images/"+prodObj.getImage()+"' alt='' /></li>");
					if(prodObj.getType().equals("FitnessWatches")||prodObj.getType().equals("SmartWatches")||prodObj.getType().equals("Headphones")||prodObj.getType().equals("PetTracker")||prodObj.getType().equals("VirtualReality"))
					{
						prodObj.setType("WearableTechnology");
					}
