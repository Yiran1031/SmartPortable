...
@WebServlet("/DateCount")

public class DateCount extends HttpServlet {
  ...
  // HashMap<String,DateSale> s = MySqlDataStoreUtilities.selectDateSale();
    ...
    pw.println("</td>");
		pw.println("<td border: 1px >");
		pw.println("Total sale");
		pw.println("</td>");
    pw.println("</tr>");
    for(Map.Entry<String, DateSale> entry : s.entrySet())
    {
        DateSale w = entry.getValue();
          pw.println("<tr>");
          pw.println("<td border: 1px >");
          pw.println(w.getDate());
          pw.println("</td>");
          pw.println("<td border: 1px >");
          pw.println(w.getCount());
          pw.println("</td>");
					pw.println("<td border: 1px >");
					pw.println(w.getTotalSale());
					pw.println("</td>");
          pw.println("</tr>");
    }
