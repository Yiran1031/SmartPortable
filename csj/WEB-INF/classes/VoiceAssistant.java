...
public class VoiceAssistant extends HttpServlet {
    ...
    public VoiceAssistant(String id, String name, double price, String image, String type,String condition,double discount,int num){
        this.id = id;
        this.name=name;
        this.price=price;
        this.image=image;
    ...
    public VoiceAssistant(String id, String name, double price, String image, String type,String condition,double discount){
        this.id = id;
        this.name=name;
        this.price=price;
        this.image=image;
