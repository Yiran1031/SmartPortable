...
public class ViewReview extends HttpServlet {
    ...
    pw.print("<div id='content'><div class='post'><h2 class='title meta'>");
		...
		//productName = r.getProductName();
		pw.print("<td>" +r.getReviewRating()+ "</td>");
		pw.print("</tr>");
		...
		//productName = r.getProductName();
		pw.print("<td>" +r.getRetailerPin()+ "</td>");
		pw.print("</tr>");
		...
		//productName = r.getProductName();
		pw.print("<td>" +r.getRetailerCity()+ "</td>");
		pw.print("</tr>");

		pw.print("<tr>");
		pw.print("<td> retailer state: </td>");
		//productName = r.getProductName();
		pw.print("<td>" +r.getRetailerState()+ "</td>");
		pw.print("</tr>");
		...
		//productName = r.getProductName();
		pw.print("<td>" +r.getRetailerName()+ "</td>");
		pw.print("</tr>");
