...
public class AddProduct extends HttpServlet{
    ...
    protected void displayadd(HttpServletRequest request,
        ...
        pw.print("<form method='post' action='AddProduct'>"
                ...
                + "<h3>name</h3></td><td></td><td><input type='text' name='name' value='' class='input' required></input>"
                + "</td></tr><tr><td>"
                + "<h3>price</h3></td><td></td><td><input type='text' name='price' value='' class='input' required></input>"
                + "</td></tr><tr><td>"
                + "<h3></h3></td><td></td><td><input type='hidden' name='image' value='null' class='input' required></input>"
                + "</td></tr><tr><td>"
                + "<h3></h3></td><td></td><td><input type='hidden' name='condition' value='new' class='input' required></input>"
                + "</td></tr><tr><td>"
                + "<h3>discount</h3></td><td></td><td><input type='discount' name='discount' value='' class='input' required></input>"
                + "</td></tr><tr><td>"
