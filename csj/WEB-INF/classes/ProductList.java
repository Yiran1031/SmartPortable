...
public class ProductList extends HttpServlet {
  ...
  // HashMap<String,SaleList> s = MySqlDataStoreUtilities.selectSaleList();
    ...
    pw.print("<a style='font-size: 24px;'>SaleList</a>");
    ...
    for(Map.Entry<String, SaleList> entry : s.entrySet())
    {
        SaleList w = entry.getValue();
          pw.println("<tr>");
          pw.println("<td border: 1px >");
          pw.println(w.getOrderName());
          pw.println("</td>");
          pw.println("<td border: 1px >");
          pw.println(w.getPrice());
          pw.println("</td>");
          pw.println("<td border: 1px >");
          pw.println(w.getCount());
          pw.println("</td>");
          pw.println("</tr>");
					totalprice = totalprice + w.getPrice()*w.getCount();
    }
		DecimalFormat df = new DecimalFormat("0.00");
    pw.println("<tr>");
    pw.println("<td border: 1px colspan=3>");
    pw.println("TotalSale:");
		pw.println(df.format(totalprice));
    pw.println("</td>");
    pw.println("</tr>");
